                  ...
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-icon">
                        <img
                          src="admin/assets/img/icons/dash-icon-01.svg"
                          alt="Dashboard Icon"
                        />
                      </div>
                    </div>
                ...
                <div className="card bg-comman w-100">
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-icon">
                        <img
                          src="admin/assets/img/icons/dash-icon-02.svg"
                          alt="Dashboard Icon"
                        />
                      </div>
                    </div>
                ...
                <div className="card bg-comman w-100">
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-icon">
                        <img
                          src="admin/assets/img/icons/dash-icon-03.svg"
                          alt="Dashboard Icon"
                        />
                      </div>
                    </div>
                ...
                <div className="card bg-comman w-100">
                  <div className="card-body">
                    <div className="db-widgets d-flex justify-content-between align-items-center">
                      ...
                      <div className="db-icon">
                        <img
                          src="admin/assets/img/icons/dash-icon-04.svg"
                          alt="Dashboard Icon"
                        />
                      </div>
                    </div>
                    ...
                    <div className="activity-groups">
                      <div className="activity-awards">
                        <div className="award-boxs">
                          <img
                            src="admin/assets/img/icons/award-icon-01.svg"
                            alt="Award"
                          />
                        </div>
                      ...
                      <div className="activity-awards">
                        <div className="award-boxs">
                          <img
                            src="admin/assets/img/icons/award-icon-02.svg"
                            alt="Award"
                          />
                        </div>
                        <div className="award-list-outs">
                      ...
                      <div className="activity-awards">
                        <div className="award-boxs">
                          <img
                            src="admin/assets/img/icons/award-icon-03.svg"
                            alt="Award"
                          />
                        </div>
                        <div className="award-list-outs">
                      ...
                      <div className="activity-awards mb-0">
                        <div className="award-boxs">
                          <img
                            src="admin/assets/img/icons/award-icon-04.svg"
                            alt="Award"
                          />
                        </div>
                        <div className="award-list-outs">
            ...
            <div className="row">
              <div className="col-xl-3 col-sm-6 col-12">
                <div className="card flex-fill fb sm-box">
                  ...
                  <div className="social-boxs">
                    <img
                      src="admin/assets/img/icons/social-icon-01.svg"
                      alt="Social Icon"
                    />
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-sm-6 col-12">
                <div className="card flex-fill twitter sm-box">
                  ...
                  <div className="social-boxs">
                    <img
                      src="admin/assets/img/icons/social-icon-02.svg"
                      alt="Social Icon"
                    />
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-sm-6 col-12">
                <div className="card flex-fill insta sm-box">
                  ...
                  <div className="social-boxs">
                    <img
                      src="admin/assets/img/icons/social-icon-03.svg"
                      alt="Social Icon"
                    />
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-sm-6 col-12">
                <div className="card flex-fill linkedin sm-box">
                  ...
                  <div className="social-boxs">
                    <img
                      src="admin/assets/img/icons/social-icon-04.svg"
                      alt="Social Icon"
                    />
                  </div>
                </div>
